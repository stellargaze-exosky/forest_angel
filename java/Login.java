...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
...

        {
            ...
            spinner = findViewById(R.id.selectHomeState);
            spinner2 = findViewById(R.id.selectHomeDistrict);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.isEmpty() || name.length()<5){
                    Toast.makeText(Login.this, "Name should be at least 5 characters long", Toast.LENGTH_SHORT).show();
                }
                else {
                    ...
                    editor.putString("stateUT", StateUT);
                    editor.putString("district", locality);
                    editor.commit();
    ...
    class StateUTSpinnerClass implements AdapterView.OnItemSelectedListener {
        ...
        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
            ...
            adapter2 = new ArrayAdapter(Login.this, android.R.layout.simple_spinner_item, mainList);
            spinner2.setAdapter(adapter2);
            adapter2.notifyDataSetChanged();
